...
class DatasetSplit(object):
    ...
    def __init__(self, images, labels, isClassification):
...
class Dataset(object):
    ...
    n_classes : number of classes, optional, default=2
    """

    def __init__(self, Xs, ys=None, split=[1.0, 0.0, 0.0], one_hot=False, n_classes=2):
        ...
        if ys is not None:
            self.all_labels = ys if not one_hot else dense_to_one_hot(ys,n_classes)
    ...
    def train(self):
        ...
        if self.all_labels is not None:
           # pdb.set_trace()
            ...
            labels = None
        return DatasetSplit(inputs, labels, self.isClassification)
